...
<head>
	...
	<link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/bootstrap.min.css?035fd0a" media="screen"/>
    ...
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery-3.3.1.min.js"></script>
    ...
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/mtheme.css?035fd0a" media="screen"/>
    <script type="text/javascript" src="<?php echo ASSETS_PATH; ?>js/bootstrap.min.js?035fd0a"></script>
    <script type="text/javascript" src="<?php echo ASSETS_PATH; ?>js/custom.js?035fd0a"></script>
    <?php
